...
#define BUZZER_FREQUENCY  2000  // 2.0 kHz tone for passive buzzers (also drives active buzzers HIGH)
#define BUZZER_BEEP_ON_MS 400   // Intermittent beep ON duration
#define BUZZER_BEEP_OFF_MS 400  // Intermittent beep OFF duration
